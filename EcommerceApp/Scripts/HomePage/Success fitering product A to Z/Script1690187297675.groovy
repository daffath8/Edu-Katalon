...
if (Mobile.verifyElementExist(findTestObject('Object Repository/HomePage/banner_PRODUCTS'), 0)){
	Mobile.tap(findTestObject('HomePage/FilterBtn'), 0)
	
	Mobile.tap(findTestObject('HomePage/AtoZ_btn'), 0)
	
	Mobile.verifyElementText(findTestObject('HomePage/VerifyTextAtoZ'), 'Sauce Labs Backpack')
} else {
